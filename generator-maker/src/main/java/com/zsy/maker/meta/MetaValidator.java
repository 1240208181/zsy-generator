...
import com.zsy.maker.meta.enums.ModelTypeEnum;
...
public class MetaValidator {
    ...
    private static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "zsy");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.zsy");
